...
나는 개발자다. 그리고 이해관계자들이신 저분들은 사무팀이다. 나는 저분들의 업무와 생각을 몰랐고, 그분들은 나의 업무와 생각을 모르셨다. 그래서 '이런 상황에서 소통이 잘 일어나려면 어떡해야할까?'라는 고민을 많이 했던 것 같다. 일딴 나 스스로 몇가지 규칙을 세워봤었다.

1. 절대 기술관련 얘기를 꺼내지 않는다.
    - 예를 들어 '데이터베이스'라는 말 조차도 꺼내지 않는다.
    - 기술적인 용어를 꺼낼 일이 생긴다면 최대한 쉽게 풀은 설명을 덧붙인다.
2. 거절, 부탁, 질문을 할 때에는 그에 대한 맥락을 얘기한다.
    - 특히 어떤 기능에 대해 거절을 할때 중요하다. 확실히 어떤 상황인지 알려드려야지 이해관계자들도 앞으로의 생각에 고려할 수 있기 때문이다.
3. 언제 어디서든 이해관계자들이 작업물을 볼 수 있도록 한다.
...
은근히 사무 쪽으로는 편법들이 꽤 많다.[^4] 사무팀 개인마다 또 그 방법이 다를 수도 있고, 대응하는 고객분마다 다를 수 있다. 이런 상황을 고려했다고 생각해도 만든 시스템으로 테스트를 해보면 부족한 경우가 다반사다.
...
[^4]: 나쁜 의미의 편법이 아니고 일을 정상적으로 처리하기 위해서 정해진 방향을 벗어나는 행위를 말한다.